...
class OneDayAgoPageBR extends StatefulWidget {
  ...
  @override
  State<OneDayAgoPageBR> createState() => _OneDayAgoBreathPageState();
}

class _OneDayAgoBreathPageState extends State<OneDayAgoPageBR> {
  ...
  void initState() {
    ...
    fetchOneDayAgoBreathData();
  }

  /// "1 day ago" = yesterday (12:00 AM -> 11:59 PM)
  Future<void> fetchOneDayAgoBreathData() async {
    setState(() {
      _loading = true;
      _error = null;
    });
    ...
    try {
      ...
      final start = DateTime(day.year, day.month, day.day); // yesterday 12:00 AM
      final end = start.add(const Duration(days: 1));       // today 12:00 AM
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("1 Day Ago Respiratory Rate"),
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: fetchOneDayAgoBreathData,
