...
class ThreeDaysAgoPageBR extends StatefulWidget {
  final String uid;
  const ThreeDaysAgoPageBR({super.key, required this.uid});

  @override
  State<ThreeDaysAgoPageBR> createState() => _ThreeDaysAgoPageStateBR();
}

class _ThreeDaysAgoPageStateBR extends State<ThreeDaysAgoPageBR> {
  ...
  void initState() {
    ...
    fetchThreeDaysAgoDataBR();
  }

  /// 3 days ago = full calendar day (12:00 AM -> 11:59 PM)
  Future<void> fetchThreeDaysAgoDataBR() async {
    setState(() {
      _loading = true;
      _error = null;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("3 Days Ago Respiratory Rate"),
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: fetchThreeDaysAgoDataBR,
