...
class SixDaysAgoPageBR extends StatefulWidget {
  final String uid;
  const SixDaysAgoPageBR({super.key, required this.uid});

  @override
  State<SixDaysAgoPageBR> createState() => _SixDaysAgoPageStateBR();
}

class _SixDaysAgoPageStateBR extends State<SixDaysAgoPageBR> {
  ...
  void initState() {
    ...
    fetchSixDaysAgoDataBR();
  }

  /// 6 days ago = full calendar day (12:00 AM -> 11:59 PM)
  Future<void> fetchSixDaysAgoDataBR() async {
    setState(() {
      _loading = true;
      _error = null;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("6 Days Ago Respiratory Rate"),
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: fetchSixDaysAgoDataBR,
