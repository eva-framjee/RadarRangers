...
class SevenDaysAgoPageBR extends StatefulWidget {
  final String uid;
  const SevenDaysAgoPageBR({super.key, required this.uid});

  @override
  State<SevenDaysAgoPageBR> createState() => _SevenDaysAgoPageStateBR();
}

class _SevenDaysAgoPageStateBR extends State<SevenDaysAgoPageBR> {
  ...
  void initState() {
    ...
    fetchSevenDaysAgoDataBR();
  }

  /// 7 days ago = full calendar day (12:00 AM -> 11:59 PM)
  Future<void> fetchSevenDaysAgoDataBR() async {
    setState(() {
      _loading = true;
      _error = null;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("7 Days Ago Respiratory Rate"),
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: fetchSevenDaysAgoDataBR,
