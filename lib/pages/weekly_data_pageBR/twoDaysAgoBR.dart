...
class TwoDaysAgoPageBR extends StatefulWidget {
  final String uid;
  const TwoDaysAgoPageBR({super.key, required this.uid});

  @override
  State<TwoDaysAgoPageBR> createState() => _TwoDaysAgoPageStateBR();
}

class _TwoDaysAgoPageStateBR extends State<TwoDaysAgoPageBR> {
  ...
  void initState() {
    ...
    fetchTwoDaysAgoDataBR();
  }

  Future<void> fetchTwoDaysAgoDataBR() async {
    DateTime now = DateTime.now();
    DateTime start = now.subtract(const Duration(days: 2));
    DateTime end = now.subtract(const Duration(days: 1));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("2 Days Ago Breath Rate"),
