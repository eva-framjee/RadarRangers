...
import 'package:flutter/material.dart';
import 'monthly_data_pageHR/oneWeekAgoHR.dart';
import 'monthly_data_pageHR/twoWeeksAgoHR.dart';
import 'monthly_data_pageHR/threeWeeksAgoHR.dart';
import 'monthly_data_pageHR/fourWeeksAgoHR.dart';

class MonthlyDataPageHR extends StatelessWidget {
  final String uid; // ← store UID

  const MonthlyDataPageHR({super.key, required this.uid}); // ← require UID

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("This Month's Heart Rate Data"),
