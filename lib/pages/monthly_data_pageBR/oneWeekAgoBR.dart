...
class OneWeekAgoPageBR extends StatefulWidget {
  final String uid;
  const OneWeekAgoPageBR({super.key, required this.uid});

  @override
  State<OneWeekAgoPageBR> createState() => _OneWeekAgoPageStateBR();
}

class _OneWeekAgoPageStateBR extends State<OneWeekAgoPageBR> {
