...
class FourWeeksAgoPageBR extends StatefulWidget {
  final String uid;
  const FourWeeksAgoPageBR({super.key, required this.uid});

  @override
  State<FourWeeksAgoPageBR> createState() => _FourWeeksAgoPageStateBR();
}

class _FourWeeksAgoPageStateBR extends State<FourWeeksAgoPageBR> {
