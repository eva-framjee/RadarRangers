...
class OneWeekAgoPageHR extends StatefulWidget {
  final String uid;
  const OneWeekAgoPageHR({super.key, required this.uid});

  @override
  State<OneWeekAgoPageHR> createState() => _OneWeekAgoPageStateHR();
}

class _OneWeekAgoPageStateHR extends State<OneWeekAgoPageHR> {
