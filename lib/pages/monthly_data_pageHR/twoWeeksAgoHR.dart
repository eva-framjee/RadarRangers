...
class TwoWeeksAgoPageHR extends StatefulWidget {
  final String uid;
  const TwoWeeksAgoPageHR({super.key, required this.uid});

  @override
  State<TwoWeeksAgoPageHR> createState() => _TwoWeeksAgoPageStateHR();
}

class _TwoWeeksAgoPageStateHR extends State<TwoWeeksAgoPageHR> {
