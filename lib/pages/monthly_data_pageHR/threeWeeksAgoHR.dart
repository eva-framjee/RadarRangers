...
class ThreeWeeksAgoPageHR extends StatefulWidget {
  final String uid;
  const ThreeWeeksAgoPageHR({super.key, required this.uid});

  @override
  State<ThreeWeeksAgoPageHR> createState() => _ThreeWeeksAgoPageStateHR();
}

class _ThreeWeeksAgoPageStateHR extends State<ThreeWeeksAgoPageHR> {
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      // 3 week ago = the 7-day block BEFORE this week
      startDate = todayMidnight.subtract(const Duration(days: 28));
      endDate = todayMidnight.subtract(const Duration(days: 21));
