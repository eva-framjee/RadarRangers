...
// lib/vitals_ble_client.dart
// CODE THAT WORKS BEFORE 4/7/2026
import 'dart:async';
import 'dart:convert';
import 'dart:typed_data';
...
//CODE THAT WORKS AFTER 4/7/2026
// lib/vitals_ble_client.dart
...
//           if (name == targetName && !completer.isCompleted) {
//             found = r.device;
...
//       try {
//         found = await completer.future.timeout(const Duration(seconds: 15));
//       } catch (_) {
//         throw Exception("Device not found: $targetName");
//       } finally {
//         await FlutterBluePlus.stopScan();
...
//     _vitalsSub?.cancel();
//     _heartWaveSub?.cancel();
//     _breathWaveSub?.cancel();

//     _vitalsSub = _vitalsJsonChar!.onValueReceived.listen((bytes) async {
//       print("LISTENER FIRED");
//       print("BLE BYTES: $bytes");
