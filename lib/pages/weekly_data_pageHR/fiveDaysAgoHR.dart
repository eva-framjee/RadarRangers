...
class FiveDaysAgoPage extends StatefulWidget {
  final String uid; // must be the Firestore doc id: users/{uid}
  const FiveDaysAgoPage({super.key, required this.uid});

  @override
  State<FiveDaysAgoPage> createState() => _FiveDaysAgoPageState();
}

class _FiveDaysAgoPageState extends State<FiveDaysAgoPage> {
  ...
  void initState() {
    ...
    fetchFiveDaysAgoData();
  }

  /// "5 days ago" = the calendar day from 5 days ago (12:00 AM -> 11:59 PM)
  Future<void> fetchFiveDaysAgoData() async {
    setState(() {
      _loading = true;
      _error = null;
    });
    ...
    try {
      ...
      final start = DateTime(day.year, day.month, day.day); // 5 days ago 12:00 AM
      final end = start.add(const Duration(days: 1));       // 4 day ago 12:00 AM
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("5 Days Ago Heart Rate"),
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: fetchFiveDaysAgoData,
