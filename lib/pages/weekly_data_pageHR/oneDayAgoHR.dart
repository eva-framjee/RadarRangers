...
class OneDayAgoPage extends StatefulWidget {
  final String uid; // must be the Firestore doc id: users/{uid}
  const OneDayAgoPage({super.key, required this.uid});

  @override
  State<OneDayAgoPage> createState() => _OneDayAgoPageState();
}

class _OneDayAgoPageState extends State<OneDayAgoPage> {
  ...
  /// "1 day ago" = yesterday (12:00 AM -> 11:59 PM), not "last 24 hours"
  Future<void> fetchOneDayAgoData() async {
    setState(() {
      _loading = true;
      _error = null;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("1 Day Ago Heart Rate"),
